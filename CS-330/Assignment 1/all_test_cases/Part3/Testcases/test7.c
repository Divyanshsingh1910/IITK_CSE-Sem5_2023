...
//Request for memory is not a multiple of 8 bytes + 16 bytes extra memory in chunk remains after servicing the request
...
int main()
{
	...
	//whole chunk is allocated without splitting
	if(*(ptr-1) != 48)
	{
